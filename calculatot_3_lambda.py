...
textDisplay=Entry(cal,font=('ariel',20,'bold'),textvariable=text_Input,bd=30,insertwidth=4,
...
btnEqual=Button(cal,padx=16,pady=16,bd=8,fg="black",font=('ariel',20,'bold'),
